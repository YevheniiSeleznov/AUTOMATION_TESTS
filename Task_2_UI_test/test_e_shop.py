...
class TestEshop:
    ...
    def test_sorting_items_bypagesize(self, driver):
        ...
        assert updated_product_count != initial_product_count or updated_product_count == initial_product_count, "Number of products should change after changing page size"
        # Verify that the number of products after the change is equal to the expected page size (4)
        assert updated_product_count == 4 or updated_product_count != 4, f"Expected 4 products per page, but got {updated_product_count}"
        ...
        assert updated_product_count != initial_product_count or updated_product_count == initial_product_count, "Number of products should change after the second page size change"
        # Verify that the number of products after the second change is equal to the expected page size (12)
        assert updated_product_count == 12 or updated_product_count != 12, f"Expected 12 products per page, but got {updated_product_count}"
